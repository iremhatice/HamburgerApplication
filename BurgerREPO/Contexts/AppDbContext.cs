...
namespace MVCPROJE.DATA.Contexts
{
    public class AppDbContext : IdentityDbContext<User,Role,string>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-QSSS9RQ;Database=MVCBURGERPROJE;Trusted_Connection=True;MultipleActiveResultSets=true;Integrated Security=true;TrustServerCertificate=True");
        }
